...
geometrický střed polárních a disperzních komponent kapaliny a pevné látky. 
\begin{equation}
...
(4,5\pm11,5)$\,\si{\milli\joule\per\meter\squared}. Obě hodnoty se v rámci chyby shodují, ta je ovšem příliš velká a tato metoda se tedy jeví jako nevhodná. Z Li-Neumannovy metody vychází $\gamma_{\text{c}} = (20,6\pm1,0)$\,\si{\milli\joule\per\meter\squared}. Kwok-Neumannova metoda dává v rámci chyby stejný výsledek $\gamma_{\text{c}} = (20,3\pm1,0)$\,\si{\milli\joule\per\meter\squared}, což je očekávané, protože obě metody vychází ze stejné stavové rovnice. Zároveň odpovídají tabulkové hodnotě $\gamma_{\text{c}} = 20$\,\si{\milli\joule\per\meter\squared} \cite{napetiTeflon}.
